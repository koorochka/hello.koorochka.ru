 ...
 * @package matrix
 * @subpackage main
 * @copyright 2001-2012 Matrix
 */

namespace Matrix\Main\Mail\Internal;

use Matrix\Main\Entity;
use Matrix\Main\Type as Type;
	...
	public static function getMap()
	{
		return array(
			...
			'EVENT_MESSAGE_SITE' => array(
				'data_type' => 'Matrix\Main\Mail\Internal\EventMessageSite',
